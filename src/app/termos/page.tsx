...
export const metadata: Metadata = {
  title: "Termos de Uso",
  description: "Termos e condições de uso do site da Ebanos Planejados.",
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-32">
      ...
      <div className="space-y-4 text-stone-600 leading-relaxed text-[15px]">
        <p>
          Ao utilizar o site da Ebanos Planejados, você concorda com os presentes termos. O site é
        ...
        <p>
          ...
          exclusiva da Ebanos Planejados e protegido por lei. É proibida a reprodução sem
        ...
        <p>
          A Ebanos Planejados não se responsabiliza por danos decorrentes do uso inadequado das
